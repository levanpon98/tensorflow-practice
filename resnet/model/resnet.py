...
class ResNetTypeI(tf.keras.Model):
    def __init__(self, layer_params, num_classes):
        ...
        self.layer1 = make_basic_block_layer(filters=64,
                                             blocks=layer_params[0])
        self.layer2 = make_basic_block_layer(filters=128,
                                             blocks=layer_params[1],
                                             stride=2)
        self.layer3 = make_basic_block_layer(filters=256,
                                             blocks=layer_params[2],
                                             stride=2)
        self.layer4 = make_basic_block_layer(filters=512,
...
class ResNetTypeII(tf.keras.Model):
    def __init__(self, layer_params, num_classes):
        ...
        self.layer1 = make_bottleneck_layer(filters=64,
                                            blocks=layer_params[0])
        self.layer2 = make_bottleneck_layer(filters=128,
                                            blocks=layer_params[1],
                                            stride=2)
        self.layer3 = make_bottleneck_layer(filters=256,
                                            blocks=layer_params[2],
                                            stride=2)
        self.layer4 = make_bottleneck_layer(filters=512,
                                            blocks=layer_params[3],
                                            stride=2)
